...
// import 'package:using_paystack/paystack_api_services.dart';
//
...
String paystackPublicKey = 'pk_test_ac7f6240fdb347887a91c0e110de40cc1b400d73';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<String> getAccessCode() async {
    var values = await APIService.initTransaction(APIService.secretKey);
    print(values);
    return values['data']['access_code'];
  ...
  _handleCheckout(BuildContext context) async {
    ...
    try {
      print([authCode]);
      var response =await APIService.chargeAuthorization(
          secretKey: APIService.secretKey,
          authCode: authCode!,
      ...
      //   logo: MyLogo(),
      // );
      print('Response in handle = $response');
      setState(() => _inProgress = false);
      _updateStatus(response['data']['reference'].toString(), response['message'].toString());
    } catch (e) {
      setState(() => _inProgress = false);
  ...
  void _verifyOnServer(String? reference) async {
    ...
    try {
      Map<String, String> headers = {
        'Authorization': 'Bearer sk_test_4df11f7af9a3919b687992e0e49f69765450b15e'
      };
      http.Response response = await http.get(Uri.parse(url),headers: headers);
      var body = response.body;
      var res = jsonDecode(body);
      _updateStatus(reference, body);
      // print('the reference i want is: ${res['data']['authorization']['authorization_code']}');
      authCode = res['data']['authorization']['authorization_code'];
